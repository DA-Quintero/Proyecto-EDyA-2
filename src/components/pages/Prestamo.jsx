...
export default function Prestamo() {
    ...
    // Obtener datos del libro (incluye título)
    useEffect(() => {
    ...
    try {
        ...
        if (libroData.disponibles <= 0) {
            setModalMessage("No quedan unidades disponibles de este libro.");
            setShowModal(true);
            return;
        }
    ...
    <>
        ...
        <div className={styles.container}>
            ...
            <form className={styles.form} onSubmit={enviarPrestamo}>
                ...
                <button
                    type="submit"
                    className={yaPrestado ? styles.botonPrestado : styles.boton}
                    disabled={yaPrestado}
                >
