...
import { logoutAuth } from "../../store/thunks/logoutAuth"; // <-- usamos el thunk correcto
...
export default function Profile() {
  ...
  // Cerrar sesión usando el thunk logoutAuth
  ...
  // Formatear fecha de "Socio desde"
  const formatFecha = () => {
  ...
  <div className={styles.container}>
      ...
      {activeTab === "informacion" && (
        <div className={styles.infoContent}>
          ...
          {/* PANEL IZQUIERDO (FIJO) YA ESTÁ FUERA */}
